...
inline  void __LEG6_TXEN() {HAL_GPIO_WritePin(LEG6_TXE_GPIO_Port,LEG6_TXE_Pin,GPIO_PIN_SET);HAL_GPIO_WritePin(LEG6_RXE_GPIO_Port,LEG6_RXE_Pin,GPIO_PIN_RESET);}
inline  void __LEG6_TXUEN() {HAL_GPIO_WritePin(LEG6_TXE_GPIO_Port,LEG6_TXE_Pin,GPIO_PIN_RESET);}
inline  void __LEG6_RXEN() {HAL_GPIO_WritePin(LEG6_TXE_GPIO_Port,LEG6_TXE_Pin,GPIO_PIN_RESET);HAL_GPIO_WritePin(LEG6_RXE_GPIO_Port,LEG6_RXE_Pin,GPIO_PIN_SET);}
