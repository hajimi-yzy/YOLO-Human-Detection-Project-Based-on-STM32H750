...
eeprom_data_t eeprom_data = {
    .init = 0,
    .gxoffset = -0.000197429f,
    .gyoffset = -0.00198156f,
    .gzoffset = -0.00145f,
    .gnorm = 9.69072f,
    .TempWhenCali = 30,
    .CMD.cmd_code = 0x4,
...
void Calibrate_MPU_Offset(IMU_Data_t *bmi088)
{
    ...
    do
    {
        ...
        {
            // 校准超时
            bmi088->GyroOffset[0] = eeprom_data.gxoffset;
            bmi088->GyroOffset[1] = eeprom_data.gyoffset;
            bmi088->GyroOffset[2] = eeprom_data.gzoffset;
            bmi088->gNorm = eeprom_data.gnorm;
            bmi088->TempWhenCali = 30;
            break;
        }
